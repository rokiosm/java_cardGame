...
public class Lobby extends JFrame {
    ...
    private void connectServer() {
        try {
            ...
            String req = in.readLine(); // ENTER_NAME
        ...
        try {
            ...
            while ((msg = in.readLine()) != null) {
                ...
                if (msg.startsWith("ROOM ")) {
                    ...
                    String roomName = extractRoomNameFromTitle();
    ...
    private String extractRoomNameFromTitle() {
        return getTitle().replace("방 로비 - " + userName, "").trim();
    }
